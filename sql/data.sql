...
VALUES ('Authentic Basque Cheesecake', '12 hours', 'Desserts', 'Advanced', 'pancakes.jpg');
...
INSERT INTO recipes (title, prep_time, category, difficulty, image_path)
VALUES ('Chocolate Chip Waffles', '20 min', 'Breakfast', 'Easy', 'pancakes.jpg');
SET @last_id = LAST_INSERT_ID();
INSERT INTO dietary_tags (recipe_id, tag_name)
VALUES (@last_id, 'Vegetarian'),
       (@last_id, 'Gluten Free');
...
INSERT INTO recipes (title, prep_time, category, difficulty, image_path)
VALUES ('Mediterranean Quinoa Salad', '20 min', 'Main Courses', 'Easy', 'pizza.jpg');
SET @last_id = LAST_INSERT_ID();
INSERT INTO dietary_tags (recipe_id, tag_name)
...
INSERT INTO recipes (title, prep_time, category, difficulty, image_path)
VALUES ('Zucchini Zoodles Pasta', '15 min', 'Main Courses', 'Easy', 'pizza.jpg');
SET @last_id = LAST_INSERT_ID();
INSERT INTO dietary_tags (recipe_id, tag_name)
VALUES (@last_id, 'Vegan'),
       (@last_id, 'Gluten Free'),
...
INSERT INTO recipes (title, prep_time, category, difficulty, image_path)
VALUES ('Honey Glazed Salmon', '25 min', 'Main Courses', 'Intermediate', 'tacos.jpg');
SET @last_id = LAST_INSERT_ID();
INSERT INTO dietary_tags (recipe_id, tag_name)
...
INSERT INTO recipes (title, prep_time, category, difficulty, image_path)
VALUES ('Thai Green Curry', '40 min', 'Main Courses', 'Intermediate', 'tacos.jpg');
SET @last_id = LAST_INSERT_ID();
INSERT INTO dietary_tags (recipe_id, tag_name)
VALUES (@last_id, 'Vegan'),
       (@last_id, 'Gluten Free'),
...
INSERT INTO recipes (title, prep_time, category, difficulty, image_path)
VALUES ('Garden Veggie Pizza', '35 min', 'Main Courses', 'Easy', 'pizza.jpg');
SET @last_id = LAST_INSERT_ID();
INSERT INTO dietary_tags (recipe_id, tag_name)
VALUES (@last_id, 'Vegetarian');
INSERT INTO ingredients (recipe_id, name)
...
INSERT INTO recipes (title, prep_time, category, difficulty, image_path)
VALUES ('Creamy Tomato Basil', '30 min', 'Soups', 'Easy', 'soup.jpg');
SET @last_id = LAST_INSERT_ID();
INSERT INTO dietary_tags (recipe_id, tag_name)
VALUES (@last_id, 'Vegetarian'),
       (@last_id, 'Gluten Free');
...
INSERT INTO recipes (title, prep_time, category, difficulty, image_path)
VALUES ('Autumn Mushroom Soup', '55 min', 'Soups', 'Intermediate', 'soup.jpg');
SET @last_id = LAST_INSERT_ID();
INSERT INTO dietary_tags (recipe_id, tag_name)
VALUES (@last_id, 'Vegetarian'),
       (@last_id, 'Gluten Free');
...
INSERT INTO recipes (title, prep_time, category, difficulty, image_path)
VALUES ('Avocado Toast Deluxe', '10 min', 'Breakfast', 'Easy', 'pancakes.jpg');
SET @last_id = LAST_INSERT_ID();
INSERT INTO dietary_tags (recipe_id, tag_name)
VALUES (@last_id, 'Vegan'),
       (@last_id, 'Vegetarian');
...
INSERT INTO recipes (title, prep_time, category, difficulty, image_path)
VALUES ('Mixed Berry Sorbet', '4 hours', 'Desserts', 'Easy', 'pancakes.jpg');
SET @last_id = LAST_INSERT_ID();
INSERT INTO dietary_tags (recipe_id, tag_name)
VALUES (@last_id, 'Vegan'),
       (@last_id, 'Vegetarian'),
